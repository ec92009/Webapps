# Webapps Codex Review 2026-05-18

Reviewed: 2026-05-18 00:00 Europe/Madrid

1/ General architecture:
- The repo acts as a static hub plus archived snapshots of other projects, which can work if canonical-source boundaries are explicit.
- A generated or validated `sites.json` would prevent hub cards, logos, local paths, statuses, and URLs from drifting.
- Archive content should remain discoverable without competing with live projects.
...
- Each entry should state whether it is local-only, GitHub Pages, active production, or legacy.
- Last-reviewed metadata would help decide what deserves attention next.
...
- Add a smoke check for the root page and representative app pages.

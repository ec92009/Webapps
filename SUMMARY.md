...
- It maps the S1-for-all project into Manou, Agnes, and Elie lanes with clickable/collapsible subprojects, filters including Done, search, counts, done-task witness cards, granular details, and copyable snapshots.
- It is deliberately public-safe: no exact addresses, IDs, account data, scans, or sensitive documents.
- The app displays `v85.1`.
...
- Latest relevant hub/app version: `v85.1`
